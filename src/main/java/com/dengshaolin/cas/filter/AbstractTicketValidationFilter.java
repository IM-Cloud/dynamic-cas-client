...
public abstract class AbstractTicketValidationFilter extends AbstractCasFilter {
     ...
     *
     * @param filterConfig the FilterConfiguration that may be needed to construct a
     *                     validator.
    ...
    protected TicketValidator getTicketValidator(FilterConfig filterConfig, final HttpServletRequest request) {
        return this.ticketValidator;
    }
...
//                        constructServiceUrl(request, response));
                final Assertion assertion = getTicketValidator(config, request).validate(ticket,
                        constructServiceUrl(request, response));
